...
import (
	...
	"github.com/teachgate/vpn-client/configyaml"
	"github.com/teachgate/vpn-client/outline/config"
	"github.com/teachgate/vpn-client/outline/platerrors"
	"github.com/teachgate/vpn-client/outline/reporting"
)
	...
	if clientConfig.DataDir == "" {
		if runtime.GOOS != "android" && runtime.GOOS != "ios" {
			...
			if err != nil {
				...
				clientConfig.DataDir = path.Join(userDir, "com.teachgate.vpn.macos")
			}
		}
	}
